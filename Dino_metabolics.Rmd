...
ggplot(ratios, aes(x = Mass_kg, y = Amide_ratio)) +
 ...
 scale_x_log10(name = "Body Mass (kg)", breaks = c(1, 10, 100, 1000, 10000), 
  ...
  scale_fill_manual(values = c("Endotherm" = "brown3", "Ectotherm" = "dodgerblue", "Dinosaur" = "gray", Pterosaur = "black", "Plesiosaur" = "white", "Synapsid" = "gray25")) +
...
ggplot(ratios, aes(x = Mass_kg, y = Amide_ratio)) +
  ...
  scale_y_log10("Amide Ratio", breaks = c(2, 3, 5, 10)) +
   scale_fill_manual(values = c("Endotherm" = "brown3", "Ectotherm" = "dodgerblue", "Dinosaur" = "gray", Pterosaur = "black", "Plesiosaur" = "white", "Synapsid" = "gray35")) +
   scale_color_manual(values = c("Endotherm" = "brown3", "Ectotherm" = "dodgerblue", "Dinosaur" = "gray", Pterosaur = "black", "Plesiosaur" = "white", "Synapsid" = "gray35")) +
